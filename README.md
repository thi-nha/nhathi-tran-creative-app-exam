...
## **Video**
Here is a QR Code to my video where you can see my demo of creating a musicvideo with this script (or you can download the video file [here](https://github.com/thi-nha/nhathi-tran-creative-app-exam/blob/main/Creating_a_musicvideo_w_Python.mp4)).
